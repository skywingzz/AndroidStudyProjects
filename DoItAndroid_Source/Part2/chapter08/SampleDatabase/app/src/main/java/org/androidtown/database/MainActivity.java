...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button showRecordBtn = (Button) findViewById(R.id.showRecord);
    ...
    public void showRecod(View view) {
        String[] colomns = {"_id", "name", "age", "phone" };
        Cursor cursor = db.query("employee", colomns, null, null, null, null, "_id");
