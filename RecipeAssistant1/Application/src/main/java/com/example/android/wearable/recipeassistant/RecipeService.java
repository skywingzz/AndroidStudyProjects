...
public class RecipeService extends Service {
    ...
    private void createNotification(Intent intent) {
        ...
        if (mRecipe.recipeImage != null) {
            ...
            ///////////////////// jes 16 //////////////////
            if(mRecipe.recipeImage.equals("imageBitmap")){
                System.out.println(MainActivity.selectedItem.image);
                builder.setLargeIcon(MainActivity.selectedItem.image);
            }else {//////////////////////////////////////////
